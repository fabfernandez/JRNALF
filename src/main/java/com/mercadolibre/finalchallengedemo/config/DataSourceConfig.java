...
@Configuration
@EnableJpaRepositories(basePackages = {"com.mercadolibre.finalchallengedemo.repository"})
...
// Retirar el comentario cuando ya se tenga conexion local a la bd en fury
  /*  @Bean
    @Qualifier("datasource")
    @Profile("local")
