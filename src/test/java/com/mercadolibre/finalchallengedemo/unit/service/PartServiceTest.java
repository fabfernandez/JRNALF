...
public class PartServiceTest {
    ...
    public void givenPartsWithoutFilter_thenReturnAllParts() {
        List<PartEntity> partsEntityList = getList("src/test/resources/allPartsEntities.json",PartEntity.class);
        List<PartDTO> partsDtoList = getList("src/test/resources/allParts.json",PartDTO.class);
    ...
    public void givenParts_thenReturnFilteredParts() {
        List<PartEntity> partsEntityList = getList("src/test/resources/filteredPartsEntities.json",PartEntity.class);
        List<PartDTO> partsDtoList = getList("src/test/resources/filteredParts.json",PartDTO.class);
    ...
    public void givenParts_thenReturnFilteredPartsAndSortedByDescriptionAsc() {
        List<PartEntity> partsEntityList = getList("src/test/resources/filteredPartsEntitiesAndSortedByDescriptionAsc.json",PartEntity.class);
        List<PartDTO> partsDtoList = getList("src/test/resources/filteredPartsAndSortedByDescriptionAsc.json",PartDTO.class);
    ...
    public void givenPart_whenFind_thenReturnPart() {
        ...
        partEntity.setLastPriceModification(null);
        partEntity.setPartStatus(null);
    ...
    public void whenAddInexistentPart_returnOk(){
        ...
        SubsidiaryEntity casaMatriz = getObject("src/test/resources/subsidiaryCasaMatriz.json",SubsidiaryEntity.class);
        ...
        PartEntity partEntity = getObject("src/test/resources/newPartEntity.json", PartEntity.class);
    ...
    public void whenAddExistentPart_returnOkWithChangedLastPriceModification(){
        ...
        PartEntity existingPartEntity = getObject("src/test/resources/modifiedPartEntity.json", PartEntity.class);

        when(subsidiaryRepository.findById(1)).thenReturn(Optional.ofNullable(casaMatriz));
        when(partRepository.findById(any())).thenReturn(Optional.ofNullable(existingPartEntity));

        PartEntity partEntity = getObject("src/test/resources/newPartEntityPriceModification.json", PartEntity.class);
        when(partRepository.save(any())).thenReturn(partEntity);
